...
# sum = tf.add(a,b)
# print(sess.run(sum,feed_dict={a:1,b:2}))
...
# b = tf.constant([[4,3],[2,1]],tf.float32)
...
#Challenge Variables and Placeholders
...
# a=sess.run(tf.truncated_normal([5,5,1,4], stddev=0.1))
# print(a)
#print(a)
